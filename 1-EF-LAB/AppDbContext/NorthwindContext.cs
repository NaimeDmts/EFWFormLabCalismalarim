...
using _1_EF_LAB.Models;

namespace _1_EF_LAB.AppDbContext
{
    public partial class NorthwindContext : DbContext
    {
        ...
        public virtual DbSet<AlisVeri> AlisVeris { get; set; } = null!;
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseSqlServer("Server=KDK-403-YZ-PC14;Database=Northwind;Trusted_Connection=True;");
            }
        }

        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<AlisVeri>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("AlisVeris");
            ...
            modelBuilder.Entity<CustomerOrderSummary>(entity =>
            {
                ...
                entity.Property(e => e.Coun).HasColumnName("COUN");
            });
